package com.pp.musicplayer.adapter;

import java.util.List;

import com.pp.musicplayer.R;
import com.pp.musicplayer.domain.Music;import android.content.Context;
...
public class AlbumsAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		//艺术家
		TextView textMusicArtist = (TextView)convertView.findViewById(R.id.music_item_artist);
		textMusicArtist.setText(m.getArtist());
		//持续时间
